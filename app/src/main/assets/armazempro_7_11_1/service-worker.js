const CACHE='armazem-pro-7-11-1-planejamento';
const ASSETS=['./','./index.html','./manifest.json','./favicon.png','./apple-touch-icon.png','./logo-armazem-pro.svg','./reset-password.html'];
